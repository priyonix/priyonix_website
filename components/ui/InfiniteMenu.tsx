...
return (
  <div className="relative w-full h-[500px] max-w-screen-xl mx-auto">

    <canvas
      id="infinite-grid-menu-canvas"
      ref={canvasRef}
      className="cursor-grab w-full h-full max-h-[500px] overflow-hidden relative outline-none active:cursor-grabbing"
    />
    ...
    {activeItem && (
      <>
        ...
        <h2
          className={`
            absolute select-none font-black text-[2.2rem] md:text-[3.5rem]
            left-8 top-1/2 transform -translate-y-1/2 z-20
        ...
        <p
          className={`
            absolute select-none max-w-[12ch] text-[1.1rem] md:text-[1.4rem]
            top-1/2 right-10 transform -translate-y-1/2 z-20
            transition-opacity duration-500 ease-in-out
            ${isMoving ? "opacity-0 pointer-events-none translate-x-[-20%]" : "opacity-100 pointer-events-auto translate-x-[-60%]"}
          `}
        >
        ...
        <div
          ...
          className={`
            absolute left-1/2 bottom-10 z-30
            w-14 h-14 grid place-items-center
            bg-[#00ffff] border-[5px] border-black rounded-full cursor-pointer
            transition-all duration-500 ease-in-out transform
            ${isMoving ? "opacity-0 pointer-events-none scale-0 -translate-x-1/2" : "opacity-100 pointer-events-auto scale-100 -translate-x-1/2"}
          `}
        >
          <p className="text-[#060010] text-[22px] select-none">&#x2197;</p>
        </div>
      </>
    )}
  </div>
